...
| A14 | 毎週の予定へ繰り返し回数3回を指定する | 最初の予定を含めて3回だけ表示され、4回目は表示されない |
| A15 | 毎月の予定へ終了日を指定する | 終了日以前に開始する回だけが表示され、終了日より後には表示されない |
...
| A14 | Pending | Pending | Pending | |
| A15 | Pending | Pending | Pending | |
